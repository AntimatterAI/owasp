  ...
  return (
    <div>
      ...
      <div className="bg-[#ffffff] box-border content-stretch flex flex-col items-start justify-start p-0 relative w-full">
          ...
          <div className="bg-[#ffffff] flex flex-col items-start justify-start overflow-clip relative shadow-[0px_12px_32px_-6px_rgba(0,0,0,0.1)] w-full">
            ...
            <div className="flex flex-col gap-6 lg:gap-8 items-start justify-start p-6 lg:p-[48px] relative w-full border-[#d7d7d7] border-[0px_1px_1px]">
              ...
              <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-center justify-start relative w-full">
                ...
                <div className="basis-0 box-border content-stretch flex flex-col gap-6 grow items-start justify-center min-h-px min-w-px p-0 relative">
                  <div className="box-border content-stretch flex flex-col gap-2 items-start justify-start p-0 relative w-full text-left">
                    ...
                    <div className="font-['Poppins'] text-[#757575] text-[14px] leading-[20px] w-full">
                      Hear from working group members Shanni Prutchi and Ryan Armstrong as they share the latest ASVS developments and future plans.
                    </div>
                  </div>
        ...
        <div className="bg-[#ffffff] box-border content-stretch flex flex-col gap-16 items-center justify-start px-[120px] py-20 relative w-full">
          ...
          <div className="box-border content-stretch flex flex-row gap-8 items-start justify-start p-0 relative w-full">
            <div className="basis-0 box-border content-stretch flex flex-col font-['Barlow'] font-medium gap-2 grow items-start justify-start min-h-px min-w-px p-0 relative text-left">
              <div className="text-[#101820] text-[32px] tracking-[-0.64px] leading-[40px] w-full">
                Maintaining Supporters
              </div>
              <div className="text-[#757575] text-[24px] tracking-[-0.48px] leading-[32px] w-full">
                through time provisions
              </div>
            </div>
            <div className="basis-0 box-border content-stretch flex flex-col gap-8 grow items-start justify-start min-h-px min-w-px p-0 relative">
          ...
          <div className="box-border content-stretch flex flex-row gap-8 items-start justify-start p-0 relative w-full">
            {/* Primary Supporters */}
            <div className="basis-0 box-border content-stretch flex flex-col grow items-start justify-start min-h-px min-w-px p-0 relative border border-[#fdcb7d]">
              <div className="bg-[#101820] box-border content-stretch flex flex-row gap-2 items-center justify-center pl-0 pr-2 py-3 relative w-full">
                <div className="relative size-6">
                  <div className="absolute h-[17.561px] left-1/2 translate-x-[-50%] translate-y-[-50%] w-[22px] bg-[#fdcb7d] rounded-full" style={{ top: "calc(50% + 0.281px)" }} />
                </div>
                <div className="font-['Poppins'] font-medium text-[#ffffff] text-[16px] text-left text-nowrap tracking-[-0.32px] leading-[24px]">
                  Primary Supporter(s)
                </div>
              </div>
              <div className="box-border content-stretch flex flex-col gap-6 items-start justify-center p-[24px] relative w-full">
                <div className="flex flex-wrap box-border gap-6 items-center justify-center p-0 relative w-full">
                  <div className="h-8 w-[103px] bg-gray-200 rounded" />
                  <div className="h-8 w-[200px] bg-gray-200 rounded" />
                  <div className="h-6 w-[172px] bg-gray-200 rounded" />
                </div>
                <div className="font-['Poppins'] text-[#757575] text-[14px] text-center leading-[20px] w-full">
                  Organizations who have donated <span className="font-['Poppins'] font-semibold text-[#101820] tracking-[-0.28px]">$7,000</span> or more to the project via OWASP. Supporter will be listed for 3 years from the date of the donation.
                </div>
              </div>
            </div>

            {/* Silver Supporters */}
            <div className="basis-0 box-border content-stretch flex flex-col grow items-start justify-start min-h-px min-w-px p-0 relative border border-[#ccd8e0]">
              <div className="bg-[#101820] box-border content-stretch flex flex-row gap-2 items-center justify-center pl-0 pr-2 py-3 relative w-full">
                <div className="relative size-6">
                  <div className="absolute h-[17.561px] left-1/2 translate-x-[-50%] translate-y-[-50%] w-[22px] bg-[#ccd8e0] rounded-full" style={{ top: "calc(50% + 0.281px)" }} />
                </div>
                <div className="font-['Poppins'] font-medium text-[#ffffff] text-[16px] text-left text-nowrap tracking-[-0.32px] leading-[24px]">
                  Silver Supporters
                </div>
              ...
              <div className="box-border content-stretch flex flex-col gap-6 items-start justify-center p-[24px] relative w-full">
                <div className="flex flex-wrap box-border gap-6 items-center justify-center p-0 relative w-full">
                  <div className="h-8 w-[95px] bg-gray-200 rounded" />
                </div>
                <div className="font-['Poppins'] text-[#757575] text-[14px] text-center leading-[20px] w-full">
                  Organizations who have donated <span className="font-['Poppins'] font-semibold text-[#101820] tracking-[-0.28px]">$3,000</span> or more to the project via OWASP. Supporter will be listed for 2 years from the date of the donation.
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="box-border content-stretch flex flex-row gap-8 items-start justify-start p-0 relative w-full">
            {/* Tertiary Supporters */}
            <div className="basis-0 box-border content-stretch flex flex-col grow items-start justify-start min-h-px min-w-px p-0 relative border border-[#fdb77d]">
              <div className="bg-[#101820] box-border content-stretch flex flex-row gap-2 items-center justify-center pl-0 pr-2 py-3 relative w-full">
                <div className="relative size-6">
                  <div className="absolute h-[17.561px] left-1/2 translate-x-[-50%] translate-y-[-50%] w-[22px] bg-[#fdb77d] rounded-full" style={{ top: "calc(50% + 0.281px)" }} />
                </div>
                <div className="font-['Poppins'] font-medium text-[#ffffff] text-[16px] text-left text-nowrap tracking-[-0.32px] leading-[24px]">
              ...
              <div className="box-border content-stretch flex flex-col gap-6 items-start justify-center p-[24px] relative w-full">
                <div className="flex flex-wrap box-border gap-6 items-center justify-center p-0 relative w-full">
                  <div className="h-8 w-[30px] bg-gray-200 rounded" />
                </div>
                <div className="font-['Poppins'] text-[#757575] text-[14px] text-center leading-[20px] w-full">
                  Organizations who have donated <span className="font-['Poppins'] font-semibold text-[#101820] tracking-[-0.28px]">$500</span> or more to the project via OWASP. Supporter will be listed for 1 year from the date of the donation.
                </div>
              </div>
            </div>

            {/* Associate Supporters */}
            <div className="basis-0 box-border content-stretch flex flex-col grow items-start justify-start min-h-px min-w-px p-0 relative border border-[#b686fc]">
              <div className="bg-[#101820] box-border content-stretch flex flex-row gap-2 items-center justify-center pl-0 pr-2 py-3 relative w-full">
                <div className="relative size-6">
                  <div className="absolute h-[17.561px] left-1/2 translate-x-[-50%] translate-y-[-50%] w-[22px] bg-[#b686fc] rounded-full" style={{ top: "calc(50% + 0.281px)" }} />
                </div>
                <div className="font-['Poppins'] font-medium text-[#ffffff] text-[16px] text-left text-nowrap tracking-[-0.32px] leading-[24px]">
              ...
              <div className="box-border content-stretch flex flex-col gap-6 items-start justify-center p-[24px] relative w-full">
                <div className="flex flex-wrap box-border gap-6 items-center justify-center p-0 relative w-full">
                  ...
                  <div className="h-8 w-[39px] bg-gray-200 rounded" />
                  <div className="h-8 w-[81px] bg-gray-200 rounded" />
                </div>
                <div className="font-['Poppins'] text-[#757575] text-[14px] text-center leading-[20px] w-full">
        ...
        <div className="bg-[#f1f6fe] box-border content-stretch flex flex-col gap-20 items-center justify-start px-[120px] py-20 relative w-full">
          {/* Recent News */}
          <div className="box-border content-stretch flex flex-col gap-12 items-start justify-start p-0 relative w-full">
            <div className="box-border content-stretch flex flex-row gap-8 items-end justify-center p-0 relative w-full">
              <div className="basis-0 font-['Barlow'] font-medium grow min-h-px min-w-px text-[#101820] text-[48px] text-left tracking-[-0.96px] leading-[48px]">
                Recent News
              </div>
              <div className="box-border content-stretch flex flex-row gap-10 h-12 items-center justify-center px-6 py-0 relative">
            ...
            <div className="box-border content-stretch flex flex-row gap-8 items-start justify-start p-0 relative w-full">
              <div className="basis-0 box-border content-stretch flex flex-col gap-4 grow items-start justify-start min-h-px min-w-px p-0 relative">
                <div className="bg-center bg-cover bg-no-repeat h-60 w-full bg-gradient-to-r from-[#003594] to-[#6496ed]" />
                <div className="box-border content-stretch flex flex-col gap-3 items-start justify-center p-0 relative w-full">
                  <div className="box-border content-stretch flex flex-row gap-2.5 items-center justify-center pl-2 pr-0 py-0 relative w-full border-l-2 border-[#003594]">
                    <div className="basis-0 font-['Poppins'] font-semibold grow min-h-px min-w-px text-[#003594] text-[14px] text-left tracking-[-0.28px] leading-[20px]">
                      Starr Brown, May 6
                    </div>
                  </div>
                  <div className="font-['Inter'] font-medium text-[#101820] text-[20px] text-left tracking-[-0.2px] leading-[28px] w-full">
          ...
          <div className="box-border content-stretch flex flex-col gap-12 items-start justify-start p-0 relative w-full">
            ...
            <div className="box-border content-stretch flex flex-row gap-8 items-start justify-start p-0 relative w-full">
              <div className="basis-0 bg-[#ffffff] box-border content-stretch flex flex-col grow items-start justify-start min-h-px min-w-px p-0 relative self-stretch">
                <div className="bg-center bg-cover bg-no-repeat h-60 w-full bg-gradient-to-r from-[#003594] to-[#6496ed]" />
                <div className="basis-0 box-border content-stretch flex flex-col grow items-center justify-between min-h-px min-w-px p-[24px] relative w-full">
                  <div className="box-border content-stretch flex flex-col gap-4 items-start justify-start p-0 relative w-full">
                    <div className="box-border content-stretch flex flex-row gap-3 items-center justify-start p-0 relative">
                      <div className="font-['Barlow'] font-medium text-[#101820] text-[40px] text-left text-nowrap tracking-[-0.8px] leading-[40px]">
                        26-30
                      </div>
                      <div className="box-border content-stretch flex flex-col font-['Poppins'] items-start justify-start p-0 relative text-[#101820] text-[14px] text-left text-nowrap leading-[20px]">
                        <div>MAY</div>
                        <div>2025</div>
                      </div>
                    </div>
                    <div className="font-['Barlow'] font-medium text-[#101820] text-[24px] text-left tracking-[-0.48px] leading-[32px] w-full">
                      OWASP Global AppSec EU 2025
                    </div>
                  </div>
                  <div className="box-border content-stretch flex flex-row gap-10 h-12 items-center justify-center px-6 py-0 relative w-full">
                    <Button text="More Info" type="Ghost Dark" size="48" />
                  </div>
                </div>
              </div>
              <div className="basis-0 bg-[#ffffff] box-border content-stretch flex flex-col grow items-start justify-start min-h-px min-w-px p-0 relative">
                <div className="bg-center bg-cover bg-no-repeat box-border content-stretch flex flex-col gap-6 h-60 items-start justify-center p-0 relative w-full bg-gradient-to-r from-[#003594] to-[#6496ed]">
                  <div className="absolute bg-[#00a7e1] box-border content-stretch flex flex-row gap-3 items-center justify-center left-1/2 px-0 py-2 top-0 translate-x-[-50%] w-[378px]">
                    <div className="overflow-clip relative size-5">
                      <Image src="/images/icons/megaphone.svg" alt="Megaphone" fill className="object-contain" />
                    </div>
                    <div className="font-['Poppins'] font-semibold text-[#ffffff] text-[14px] text-left text-nowrap tracking-[-0.28px] leading-[20px]">
        ...
        {/* Final CTA Section */}
        <div className="bg-[#101820] box-border content-stretch flex flex-col gap-16 items-center justify-start px-[120px] py-20 relative w-full">
          <div className="box-border content-stretch flex flex-col gap-16 items-start justify-start p-0 relative w-full">
            <div className="font-['Barlow'] font-medium text-[#ffffff] text-[48px] text-left tracking-[-0.96px] leading-[48px] w-full">
              Volunteer for the ASVS
            </div>
            <div className="box-border content-stretch flex flex-row gap-8 items-start justify-start p-0 relative w-full">
              
              {/* Build the Standard */}
              <div className="basis-0 bg-[#182430] box-border content-stretch flex flex-col grow h-[400px] items-start justify-between min-h-px min-w-px p-[24px] relative">
                <div className="bg-[#101820] box-border content-stretch flex flex-row gap-2.5 items-center justify-center p-[12px] relative size-[60px]">
                ...
                <div className="box-border content-stretch flex flex-col gap-8 items-start justify-start p-0 relative w-full">
                  <div className="box-border content-stretch flex flex-col gap-2 items-start justify-start p-0 relative w-full text-left">
                    <div className="font-['Barlow'] font-medium text-[#ffffff] text-[24px] tracking-[-0.48px] leading-[32px] w-full">
                      Build the Standard
                    </div>
                    <div className="font-['Poppins'] text-[#d7d7d7] text-[14px] leading-[20px] w-full">
                  ...
                  <div className="box-border content-stretch flex flex-row gap-10 h-14 items-center justify-center px-8 py-0 relative w-full">
              ...
              <div className="basis-0 bg-[#182430] box-border content-stretch flex flex-col grow h-[400px] items-start justify-between min-h-px min-w-px p-[24px] relative">
                ...
                <div className="box-border content-stretch flex flex-col gap-8 items-start justify-start p-0 relative w-full">
                  ...
                  <div className="bg-[#003594] box-border content-stretch flex flex-row gap-10 h-14 items-center justify-center px-8 py-0 relative w-full">
