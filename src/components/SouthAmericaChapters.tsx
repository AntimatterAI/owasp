...
export default function SouthAmericaChapters() {
  ...
  const southAmericaCountries = [
    ...
    },
    {
      flag: "🇧🇷",
      country: "Brazil", 
      chapters: ["Belem", "Belo Horizonte", "Brasilia", "Curitiba", "Fortaleza", "Goiânia", "Joao Pessoa", "Juiz de Fora", "Natal", "Porto Alegre", "Recife", "Rio De Janeiro", "Salvador", "São José dos Campos", "Sao Paulo", "Teresina", "Vitoria"]
    },
    {
      flag: "🇨🇱",
      country: "Chile",
    ...
    },
    {
      flag: "🇨🇴",
      country: "Colombia",
      chapters: ["Bogota", "Cartagena", "Medellin"]
    },
    {
      flag: "🇪🇨",
      country: "Ecuador",
      chapters: ["Guayaquil", "National Polytechnic School CEC-EPN"]
    },
    {
      flag: "🇲🇽",
      country: "Mexico",
      chapters: ["Aguascalientes"]
    },
    {
      flag: "🇵🇾",
      country: "Paraguay",
      chapters: ["Asuncion, Paraguay"]
    },
    {
      flag: "🇵🇪",
      country: "Peru",
  ...
  for (let i = 0; i < southAmericaCountries.length; i += 3) {
    groupedCountries.push(southAmericaCountries.slice(i, i + 3));
  }
