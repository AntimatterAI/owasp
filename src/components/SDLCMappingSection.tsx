      ...
      <div className="max-w-[1440px] mx-auto px-[120px] py-20">
        <div className="flex flex-col gap-16 items-center justify-start">
          ...
          <div className="flex flex-col gap-8 items-center text-center w-full">
            <h2 className="font-['Barlow'] font-medium text-[#ffffff] text-[48px] leading-[48px] tracking-[-0.96px]">
              OWASP Projects Mapped to the SDLC
            </h2>
            <p className="font-['Poppins'] text-[#d7d7d7] text-[16px] leading-[24px] tracking-[-0.32px] max-w-4xl">
          ...
          <div className="flex flex-col gap-8 w-full">
            <h3 className="font-['Barlow'] font-medium text-[#ffffff] text-[32px] leading-[40px] tracking-[-0.64px] text-center">
              Application Security Wayfinder
            </h3>
