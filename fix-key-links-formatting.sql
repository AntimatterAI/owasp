-- Fix Key Links formatting to display as proper bullet list
-- The issue is that links are separated by \n\n which splits them into separate paragraphs
-- We need them as a single paragraph with \n separating the lines
...
- **2021 Sponsor**: Secure Code Warrior
- **2017 Sponsor**: Autodesk and OWASP NoVA Chapter
- **Historical Sponsors**: Aspect Security (2003-2013)

## Data 2025 Initiative
We are collecting the most comprehensive dataset related to identified application vulnerabilities to enable analysis for the Top 10 and other future research. Data contributions accepted until July 31, 2025.

- **Contribution Methods**: Email CSV/Excel files or upload via https://bit.ly/OWASPTop10Data
- **Template Examples**: https://github.com/OWASP/Top10/tree/master/2025/Data
- **Infrastructure**: Leveraging OWASP Azure Cloud Infrastructure'
